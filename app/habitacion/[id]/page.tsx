        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              {/* Amenities */}
              <div className="bg-black/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gold/20">
                <h3 className="text-xl font-serif font-bold text-white mb-4">Servicios incluidos</h3>
              ...
              {/* Botón de reserva */}
              <div className="bg-black/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gold/20">
                <h3 className="text-xl font-serif font-bold text-white mb-4">Reservar esta habitación</h3>
