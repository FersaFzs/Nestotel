  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0'>
        <Image src='/images/pasillo.jpeg' alt='Pasillo del hotel' fill className='object-cover' />
...
function EventsSection() {
  ...
  return (
    ...
    >
      {/* Imagen de fondo */}
      <div className='absolute inset-0'>
        <Image src='/images/salon-comedor.jpeg' alt='Salón comedor' fill className='object-cover' />
        <div className='absolute inset-0 bg-black/70' />
      </div>
...
export default function HomePage() {
  ...
  return (
    <main className='bg-gradient-to-br from-black via-gray-900 to-black min-h-screen w-full'>
      ...
      <div
        ref={bookingRef}
        className={`fixed top-32 left-4 z-40 transition-transform duration-500 ease-out hidden lg:block ${
