...
export default function LoadingScreen({ onLoadingComplete, isLoading, progress = 0 }: LoadingScreenProps) {
  ...
  return (
      ...
      {/* Barra de progreso */}
      <div ref={progressRef} className="relative z-10 w-80 h-1 bg-gold/20 rounded-full overflow-hidden">
        <div
          ref={progressBarRef}
